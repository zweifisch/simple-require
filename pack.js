...
(function() {
  var concatScripts, flatten, fs, getDependencies, getDependencyTree, getSimpleRequire, main, minify, parseFileList, path, prettyPrint, program, scanForRequire, uglifyjs,
  ...
  getDependencies = function(filename, dict) {
